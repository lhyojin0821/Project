...
class SearchMovieCast extends StatefulWidget {
  final SearchModel movieData;
  SearchMovieCast({required this.movieData});

  @override
  _SearchMovieCastState createState() => _SearchMovieCastState(this.movieData);
}

class _SearchMovieCastState extends State<SearchMovieCast> {
  late SearchModel movieData;

  _SearchMovieCastState(this.movieData);
    ...
    return Container(
      child: FutureBuilder(
        ...
        builder: (BuildContext context,
            AsyncSnapshot<List<MovieCastModel>> snapshot) {
          if (snapshot.hasData) {

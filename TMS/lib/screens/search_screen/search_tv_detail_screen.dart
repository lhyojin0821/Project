...
import 'package:tms/widgets/search_widget/search_tv_cast.dart';
import 'package:tms/widgets/search_widget/search_tv_info.dart';
import 'package:tms/widgets/search_widget/search_tv_similar.dart';
import 'package:tms/widgets/tv_main_widget/tv_video_player.dart';
import 'package:youtube_player_flutter/youtube_player_flutter.dart';

class SearchTvDetailScreen extends StatefulWidget {
  final SearchModel tvData;
  SearchTvDetailScreen({required this.tvData});

  @override
  _SearchTvDetailScreenState createState() =>
      _SearchTvDetailScreenState(this.tvData);
}

class _SearchTvDetailScreenState extends State<SearchTvDetailScreen> {
  ...
  Widget _videoImage(Future<TvDetailModel> tvDetail, SearchModel tvData) {
    return Container(
      child: Column(
        children: [
          FutureBuilder(
          ...
          SearchTvInfo(tvData: this.tvData),
          SearchTvSimilar(tvData: this.tvData),
          SearchTvCast(tvData: this.tvData),
        ],
      ),
    );
  }

  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body: GridView(
        ...
        children: [
          _gridTile(text: 'TV', imgUrl: 'https://images.unsplash.com/photo-1589569334232-fdc917c38226?ixid=MnwxMjA3fDB8MHxzZWFyY2h8Njl8fG1vdmllfGVufDB8fDB8fA%3D%3D&ixlib=rb-1.2.1&auto=format&fit=crop&w=800&q=60', onTap: () {}),
          _gridTile(
              text: 'MOVIE',

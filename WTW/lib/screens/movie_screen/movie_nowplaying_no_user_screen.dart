...
class MovieNowPlayingNoUserScreen extends StatefulWidget {
  final int movieId;

  MovieNowPlayingNoUserScreen({
    required this.movieId,
  });

  @override
  _MovieNowPlayingNoUserScreenState createState() =>
      _MovieNowPlayingNoUserScreenState(
        this.movieId,
      );
}

class _MovieNowPlayingNoUserScreenState
    extends State<MovieNowPlayingNoUserScreen> {
  final int movieId;

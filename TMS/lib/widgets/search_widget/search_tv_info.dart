...
class SearchTvInfo extends StatefulWidget {
  final SearchModel tvData;
  SearchTvInfo({required this.tvData});

  @override
  _SearchTvInfoState createState() => _SearchTvInfoState(this.tvData);
}

class _SearchTvInfoState extends State<SearchTvInfo> {
  late SearchModel tvData;

  _SearchTvInfoState(this.tvData);

...
class MovieDetailVideo extends StatefulWidget {
  final MovieModel movieData;
  MovieDetailVideo({required this.movieData});

  @override
  _MovieDetailVideoState createState() => _MovieDetailVideoState(this.movieData);
}

class _MovieDetailVideoState extends State<MovieDetailVideo> {
  late MovieModel movieData;
  _MovieDetailVideoState(this.movieData);
